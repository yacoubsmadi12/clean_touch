...
/// White background.
///
/// Animated checkmark icon (Turquoise #00BFA6).
///
/// Title: "Booking Confirmed!" (Black #212121, bold).
///
/// Subtitle: "Your service has been booked successfully."
///
/// Show summary: Service Title, Date, Time, Address, Provider Name.
///
/// Button: "Go to My Bookings" (Orange #FF9800, white text).
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'by96e13c' /* Your service has been booked s... */,
                      ),
                      textAlign: TextAlign.center,
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'zthmmc3u' /* Home Cleaning Service */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'uvvilzry' /* 123 Oak Street, Downtown
New Y... */
                                        ,
                                      ),
                ...
                FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(MyBookingspageWidget.routeName);
                  },
                  text: FFLocalizations.of(context).getText(
                    '2xn8w696' /* Go to My Bookings */,
                  ),
